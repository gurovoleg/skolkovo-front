...
import { withRemoteData, PageLayout, SelectControl } from 'Components'
...
import { Answer, Label as AppraisalLabel } from './components'
...
const Appraisal = ({ appraisal, initialValues, submit }) => {
  const { workshop, quiz, users } = appraisal

  return (
    <PageLayout title="Аттестация">
...
})(connect(mapStateToProps, mapDispatchToProps)(Appraisal))
